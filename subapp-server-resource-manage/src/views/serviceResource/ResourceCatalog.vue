<!-- 
  @description 服务资源-资源目录
  @date 2022/1/30
 -->
<template>
  <div class="resource-catalog">
    <div class="protitle">{{proEnv==='heilongjiang'?'数据目录':'资源目录'}}</div>
    <div class="promain">
      <el-card class="left">
        <header>
          <span>目录列表</span>
      ...
      <el-card class="right">
        ...
        <el-form label-width="80px" ref="form" :model="form" :rules="formRules" v-loading="infoLoading" size="small">
