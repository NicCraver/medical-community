      ...
      <ProTable>
        ...
        <el-table ref="table" tooltip-effect="light" height="0" v-adaptive="{ bottomOffset: 105 }" v-loading="loading" :data="tableData" @selection-change="handleSelectionChange" border stripe>
          ...
          <el-table-column label="规则类型" prop="type">
            <template>{{proEnv==='heilongjiang'?'合法性':'整合性'}}</template>
          </el-table-column>
          ...
          <el-table-column label="关联表名" prop="targetTableName" min-width="250" show-overflow-tooltip></el-table-column>
          <el-table-column label="关联表字段名称" prop="targetVariableName" min-width="150" show-overflow-tooltip></el-table-column>
...
import Add from "./IntegratedAdd.vue";
