    ...
    <el-card>
      <ProTable>
        ...
        <template #batchActions>
          <el-button size="small" icon="iconfont icon-plus" type="primary" @click="$refs.add.open('add')">新增</el-button>
        ...
        <el-table ref="table" tooltip-effect="light" height="0" v-adaptive="{ bottomOffset: 105 }" v-loading="loading" :data="tableData" @selection-change="handleSelectionChange" border stripe>
          ...
          <!-- <el-table-column label="业务表名称" prop="businessTableNode" min-width="150"></el-table-column> -->
          ...
          <!-- <el-table-column label="业务字典表名称" prop="targetTableNode" min-width="120"></el-table-column> -->
          <el-table-column label="业务字典表名" prop="targetTableName" min-width="200" show-overflow-tooltip></el-table-column>
          <el-table-column label="字典表字段名" prop="targetVariableName" min-width="150" show-overflow-tooltip></el-table-column>
...
import Add from "./CoherenceAdd.vue";
