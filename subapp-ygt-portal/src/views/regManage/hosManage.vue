<!--
  @description 注册管理系统-机构注册
  @date 2021/11/01
-->
<template>
  <div class="hosManage">
    <div class="protal-title">机构注册</div>
...
export default {
  ...
  data() {
    return {
      ...
      columnParams: [
        ...
        {
          prop: "administrativeDivisionsCode",
          label: "所属行政区划代码",
          width: 150,
        },
        {
          prop: "administrativeDivisionsDesc",
          label: "所属行政区划",
          width: 120,
        },
        {
        ...
        {
          prop: "subordinateRelationshipCode",
          label: "机构隶属关系代码",
          width: 150,
        },
        {
          prop: "subordinateRelationshipDesc",
          label: "机构隶属关系",
          width: 120,
        },
        {
  ...
  methods: {
    ...
    // 查询左侧树
    getTree() {
      getOnQueryOrgsTree({ orgTypes: ["_ORG_", "_HOS_"] }).then((res) => {
    ...
    async setOut() {
      ...
      reader.onload = function (e) {
        var parent = document.getElementsByClassName("hosManage")[0];
