 ...
 * @LastEditTime: 2023-02-15 11:55:19
 * @LastEditors: Nic
 * @Description: 
 * @FilePath: /medical-community/subapp-manage-module/src/views/ApprovalFlowManagement/ApprovalFlowManagement.vue
-->
<template>
...
import HasClosed from "./HasClosed";

export default {
  components: { ProLayout, LoadStart, HasStarted, HasClosed },
  data() {
    return {
      activeComponent: "LoadStart",
      tabDatas: [
        {
          label: "待开启",
          component: "LoadStart",
