  ...
  <div>
    <ProList class="ProList" :pageParams="pageParams" :total="total" :onInquire="onInquire">
      ...
      >
        ...
        <el-table-column label="确认转入机构" prop="ackInHosName" width="160" />
        <el-table-column label="确认转入科室" prop="auditDeptName" width="160" />
        <el-table-column label="操作" fixed="right" width="100">
          <template slot-scope="{ row }">
            <el-button type="text" @click="pageToAdmissionsListDetail('examine', row)"
              >查看</el-button
            >
            <el-button type="text" @click="pageToAdmissionsListDetail('submit', row)"
              >接诊</el-button
            >
          </template>
        </el-table-column>
